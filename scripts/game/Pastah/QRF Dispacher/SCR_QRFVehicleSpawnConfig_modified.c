class SCR_QRFVehicleSpawnConfig_modified
{
	...
	SCR_ScenarioFrameworkQRFSlotAI m_parentSlot;
	...
	//! \param[in] parentSlot which was used to spawn the parent vehicle
	void SCR_QRFVehicleSpawnConfig_modified(notnull SCR_BaseCompartmentManagerComponent vehicleCompartmentMGR, SCR_EQRFGroupType groupType, vector targetPosition, notnull SCR_ScenarioFrameworkQRFSlotAI slot, notnull SCR_ScenarioFrameworkQRFSlotAI parentSlot)
	{
